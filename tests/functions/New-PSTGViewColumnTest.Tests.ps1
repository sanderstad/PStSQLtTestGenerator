...
Describe "$commandname Integration Tests" -Tags "IntegrationTests" {
    ...
    Context "Create View Column Test" {
        $result = New-PSTGViewColumnTest -SqlInstance $script:instance -Database $script:database -View $views -OutputPath $script:unittestfolder -EnableException
    ...
    Context "Using Pipeline" {
        $result = $views | New-PSTGViewColumnTest -SqlInstance $script:instance -Database $script:database -OutputPath $script:unittestfolder -EnableException
