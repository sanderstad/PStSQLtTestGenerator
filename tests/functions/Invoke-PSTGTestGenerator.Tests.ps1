...
Describe "$CommandName Unit Tests" -Tag 'UnitTests' {
    Context "Validate parameters" {
        ...
        [object[]]$knownParameters = 'SqlInstance', 'SqlCredential', 'Database', 'OutputPath', 'TemplateFolder', 'Function', 'Procedure', 'Table', 'Index', 'View', 'SkipDatabaseTests', 'SkipFunctionTests', 'SkipProcedureTests', 'SkipTableTests', 'SkipIndexTests', 'SkipViewTests', 'TestClass', 'EnableException'
