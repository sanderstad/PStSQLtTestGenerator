...
Remove-Module PStSQLtTestGenerator -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PStSQLtTestGenerator.psd1"
Import-Module "$PSScriptRoot\..\PStSQLtTestGenerator.psm1" -Force
